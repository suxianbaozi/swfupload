package {
	...
	{ 
		...
		public var js_object:Object;
		public var canCompress:Number = 0;
                public var forUploadData:ByteArray;
		...
		public function FileItem(file_reference:FileReference, control_id:String, index:Number)
		{
			...
			this.index = index;
			this.sign_index = file_reference.name+'_'+file_reference.size;
			this.js_object = {
				id: this.id,
				index: this.index,
			...
			try {
				...
				this.js_object.modificationdate = this.file_reference.modificationDate || new Date(0);
                                this.js_object.sign_index = this.sign_index;
                                this.js_object.canCompress = this.canCompress;
			} catch (ex:Error) {
